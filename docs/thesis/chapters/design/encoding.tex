...
\todo[inline]{This subsection needs a lot more polishing, transitionary texts, explainations, and one complete proof. It is by no measure complete, but I wanted to finish other, easier stuff before completing this section. Maybe, algorithms should also be moved out of ``figures'' and into the theorems?}
...
\todo[inline]{Split up the definition of the different moves, structure everything into one subsection per move.}
...
\todo[inline]{Theorem for algorithm \ref{alg:am_swap_related}}
